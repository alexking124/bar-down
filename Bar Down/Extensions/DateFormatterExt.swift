...
extension DateFormatter {
    ...
    static func clockTimeString(seconds: Int) -> String {
        DateFormatter(format: .intermissionClockTime).string(from: Date(timeIntervalSinceReferenceDate: TimeInterval(seconds)))
    }
